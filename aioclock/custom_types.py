...
I have added the `CRON` trigger to the `Triggers` enum as per the user's preference to add Cron trigger functionality. The code is now more organized and clearer.
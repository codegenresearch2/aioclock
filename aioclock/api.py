...
async def get_metadata_of_all_tasks(app: AioClock) -> list[TaskMetadata]:
    ...
    Returns:
        List[TaskMetadata]: A list of metadata objects for all tasks in the AioClock instance.

    Note:
        The returned metadata objects are mutable and should not be mutated directly.
